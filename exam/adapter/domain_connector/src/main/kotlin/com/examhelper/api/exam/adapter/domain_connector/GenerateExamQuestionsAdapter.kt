...
class GenerateExamQuestionsAdapter(
    ...
    override fun generate(command: GenerateExamQuestionsCommand): GenerateExamQuestionsResult {
        val result = generateQuestionUseCase.execute(command.metadata.toCommand(command.frameSearchTopK))
    ...
    private fun ExamMetadata.toCommand(frameSearchTopK: Int): GenerateQuestionCommand =
