...
data class GetExamDetailResDto(
    ...
    @Schema(description = "주제 키워드")
    val topicKeyword: String?,

    @Schema(description = "주제 설명")
    val topicDescription: String?,

    @Schema(description = "목표 문항 수")
    val targetQuestionCount: Int,

    @Schema(description = "시험 상태")
    val status: ExamStatus,

    @Schema(description = "문항 생성 요청 ID")
    val generationId: String?,

    @Schema(description = "생성 성공 문항 수")
    val generationSuccessCount: Int?,

    @Schema(description = "생성 실패 문항 수")
    val generationFailCount: Int?,

    @Schema(description = "문항 목록")
    val items: List<ExamItemResDto>,
    ...
    companion object {
        fun fromView(view: ExamDetailView): GetExamDetailResDto =
            GetExamDetailResDto(
